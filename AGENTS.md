...
## What This Repo Is
A fork of GitHub's "Introduction to GitHub" exercise template with OSS
hygiene scaffolding added. It is a **documentation + workflow** repo —
no compiled source, no build step, no test suite.
